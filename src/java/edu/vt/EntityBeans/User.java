...
public class User implements Serializable {
  ...
  @OneToMany(mappedBy = "userId")
  private Collection<UserInterests> userInterestsCollection;
  ...
  @XmlTransient
  public Collection<UserInterests> getUserInterestsCollection() {
    return userInterestsCollection;
  }

  public void setUserInterestsCollection(Collection<UserInterests> userInterestsCollection) {
    this.userInterestsCollection = userInterestsCollection;
  }
